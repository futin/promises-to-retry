 ...
 *  'ALL_COMBINED' | 'ALL_SPLIT'
 * )} responseMode                                Different mode will provide different responses,
 *                                                depending on caller requirements.
 * @returns {Function}
 */
const batchPromises = ({ maxBatchSize = 2, delayInMs = 1000, responseMode = 'ALL_COMBINED' }) =>
  /**
  ...
  async promises => {
    ...
    return responseByMode[responseMode]({ resolvedPromises, rejectedPromises });
  };
